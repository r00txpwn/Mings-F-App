...
export function DeliveryScreen() {
  ...
  const zonesT = useMemo<ZonesTabTranslations>(
    () => ({
      ...
      openGeoJsonIo: t.deliveryZoneOpenGeoJsonIo,
      exportGeoJson: t.deliveryZoneExport,
      copied: t.deliveryZoneCopied,
      ...
      errorEmpty: t.deliveryZoneErrorEmpty,
      errorJson: t.deliveryZoneErrorJson,
      errorPolygon: t.deliveryZoneErrorPolygon,
      errorPoints: t.deliveryZoneErrorPoints,
      errorTooFew: t.deliveryZoneErrorTooFew,
      autoClosed: t.deliveryZoneAutoClosed,
